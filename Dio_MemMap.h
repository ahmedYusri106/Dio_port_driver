...
#ifndef MYHWDRIV_AUTOSARCOMP_AUTOSAR_SWS_DIODRIVER_DIO_MEMMAP_H_
#define MYHWDRIV_AUTOSARCOMP_AUTOSAR_SWS_DIODRIVER_DIO_MEMMAP_H_
...
#endif /* MYHWDRIV_AUTOSARCOMP_AUTOSAR_SWS_DIODRIVER_DIO_MEMMAP_H_ */
